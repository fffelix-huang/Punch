#ifndef PUNCH_CHESS_ATTACKS_H_
#define PUNCH_CHESS_ATTACKS_H_
...
// clang-format off
inline constexpr Bitboard kPawnAttacks[2][64] = {
    // white pawn attacks
    {
...
inline constexpr Bitboard kKnightAttacks[64] = {
...
inline constexpr Bitboard kKingAttacks[64] = {
...
extern Bitboard rook_attacks[0x19000];
extern Bitboard bishop_attacks[0x1480];
...
[[nodiscard]] inline constexpr Bitboard GetPawnAttacks(Square sq,
                                                       Color c) noexcept {
  return internal::kPawnAttacks[c][sq];
}

[[nodiscard]] inline constexpr Bitboard GetKnightAttacks(Square sq) noexcept {
  return internal::kKnightAttacks[sq];
}

[[nodiscard]] inline Bitboard GetBishopAttacks(Square sq,
                                               Bitboard occ) noexcept {
  const internal::Magic& m = internal::bishop_magics[sq];
  int index = ((occ & m.mask) * m.magic) >> m.shift;
  return m.attacks[index];
}

[[nodiscard]] inline Bitboard GetRookAttacks(Square sq, Bitboard occ) noexcept {
  const internal::Magic& m = internal::rook_magics[sq];
  int index = ((occ & m.mask) * m.magic) >> m.shift;
  return m.attacks[index];
}

[[nodiscard]] inline Bitboard GetQueenAttacks(Square sq,
                                              Bitboard occ) noexcept {
  return GetBishopAttacks(sq, occ) | GetRookAttacks(sq, occ);
}

[[nodiscard]] inline constexpr Bitboard GetKingAttacks(Square sq) noexcept {
  return internal::kKingAttacks[sq];
}

}  // namespace punch::attacks

#endif  // PUNCH_CHESS_ATTACKS_H_
